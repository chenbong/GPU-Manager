...
def model_profiling(model, model_cfg, batch=1, channel=3, use_cuda=False, print_=False, verbose=False):
    ...
    model.eval()
    data = torch.rand(batch, channel, max(args.resolution_range), max(args.resolution_range))
